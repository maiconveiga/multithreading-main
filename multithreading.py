...
# cabeçalhos globais a serem usados para solicitações
...
def extract_movie_details(movie_link):
    ...
    response = BeautifulSoup(requests.get(movie_link, headers=headers, verify=False).content, 'html.parser')
    movie_soup = response
...
def main():
    ...
    response = requests.get(popular_movies_url, headers=headers, verify=False)
